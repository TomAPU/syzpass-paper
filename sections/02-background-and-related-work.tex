...
Prior work identifies sensitive kernel objects \cite{chen2019slake, chen2020systematic, wang2023alphaexp, xie2025bridgerouter} and uses them to pivot a primitive to get more severe ones (e.g., infoleak, arbitrary read and arbitrary write).
