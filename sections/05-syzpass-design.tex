...
SyzPass separates this reasoning from the attacker's capability model. Table~\ref{tab:capability-models} summarizes the two models used throughout the paper: object matching ($\mathsf{OM}$), our portable baseline, and pointer materialization ($\mathsf{PM}$), a stronger model for pointer-related primitives.
